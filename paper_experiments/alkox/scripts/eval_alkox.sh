#!/bin/bash
# =============================================================================
# eval_alkox.sh — Paper-level scale sweep evaluation for Alkox
#
# Usage:
#   bash paper_experiments/alkox/eval_alkox.sh
#
...
# --- Paths ---
MODEL_PATH="paper_experiments/alkox/models/default/ppo_best.pt"
TAF_DATA="./data/taf_source_data_alkox_emulator_k10_transform.pkl"
SAVE_DIR="paper_experiments/alkox/results/${SURROGATE}"

echo "=== Alkox Paper Evaluation ==="
