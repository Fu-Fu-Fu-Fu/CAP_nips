#!/bin/bash
# =============================================================================
# Eval Trajectory Ablation: Random — Hartmann-6D (gp + tabpfn parallel)
#
# Usage:
#   bash paper_experiments/ablation/scripts/eval_random_traj_hartmann6d.sh
# =============================================================================
set -euo pipefail
...
TAF_DATA="${EXP_DIR}/data/taf_source_data_hartmann_6d_family_random_k10.pkl"
...
run_eval() {
    ...
    echo "=== Eval random_traj Hartmann-6D (${SURROGATE}) ==="
