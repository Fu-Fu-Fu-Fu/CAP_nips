#!/bin/bash
# =============================================================================
# train_hartmann3d.sh — Hartmann-3D Family (3D) training pipeline
#
# Pipeline: Step 1 (data gen) -> Step 1.5 (TAF) -> Step 2 (train CAP-PPO)
#
# Hartmann-3D is a 3D synthetic function family.  Uses oracle_gp objective
# with z-norm + regret_balanced reward (aligned with HPLC proven config).
#
# Usage:
#   bash paper_experiments/hartmann3d/train_hartmann3d.sh
# =============================================================================
...
echo "=== Hartmann-3D Family (3D) Training Pipeline ==="
echo "Repo: ${REPO_ROOT}"
...
# ===== Paths (all under experiment dir) =====
EXP_DIR="paper_experiments/hartmann3d"
...
RL_GRID_SIZE=100              # Sobol 10000 points for dim=3
...
# =============================================================================
echo "[Step 2] Train CAP-PPO (${RL_TOTAL_EPISODES} ep, dim=3, oracle_gp, z-norm, regret_balanced)..."
...
echo "  3. Run eval:        bash ${EXP_DIR}/eval_hartmann3d.sh"
