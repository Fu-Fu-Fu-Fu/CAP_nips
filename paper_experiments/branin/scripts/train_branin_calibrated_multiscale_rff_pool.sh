#!/bin/bash
# =============================================================================
# Branin calibrated multi-scale RFF + pool tuning
#
# Based on calibrated_multiscale_rff, but changes candidate-pool construction to
# reduce right-bottom basin lock-in:
#   k_centers=3, local_h=2.0, local_h_decay=0.95, explore_fraction=0.25
#
# Usage:
...
RUN_DIR="paper_experiments/branin/runs/ppo_branin_family_calibrated_multiscale_rff_pool_ep5000"
MODEL_DIR="paper_experiments/branin/models/calibrated_multiscale_rff_pool"
...
echo "================================================================"
echo "  Branin calibrated multi-scale RFF + pool tuning"
echo "================================================================"
echo "  objective_source          : oracle_gp"
echo "  normalize_oracle_gp       : YES (z-norm GP mean)"
echo "  oracle_gp_rff_normalize_x : YES ([0,1]^d RFF coordinates)"
...
echo ""
echo "Next:"
echo "  bash paper_experiments/branin/scripts/eval_branin_calibrated_multiscale_rff_pool.sh"
